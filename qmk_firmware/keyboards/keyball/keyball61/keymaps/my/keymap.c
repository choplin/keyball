...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_universal(
    ...
    KC_TAB          , LCTL_T(KC_A) , KC_S     , KC_D     , LT(MOUSE,KC_F) , KC_G     ,                                  KC_H     , KC_J     , KC_K     , KC_L     , KC_SCLN  , KC_RBRC  ,
    LALT_T(KC_MINS) , LSFT_T(KC_Z) , KC_X     , KC_C     , LT(ARROW,KC_V) , KC_B     , KC_LGUI  ,              KC_RGUI, KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , LALT_T(KC_BSLS)  ,
    _______         , _______      , KC_LALT  , KC_LGUI,        KC_BSPC , KC_SPC, KC_LCTL,    KC_RCTL , LT(NUM, KC_ENT)          ,_______   ,_______   , _______  , _______  , _______
  ),

  [NUM] = LAYOUT_universal(
    _______         , _______      , _______  , _______  , _______        , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    KC_EQL, S(KC_Q)  , S(KC_W)  , S(KC_E)  , S(KC_R)  , S(KC_T)  ,                                  S(KC_Y)  , S(KC_U)  , S(KC_I)  , S(KC_O)  , S(KC_P)  ,S(KC_INT3),
    LSFT(KC_EQL), KC_1  , KC_2  , KC_3  , KC_4  , KC_5  ,                                  KC_6  , KC_7  , KC_8  , KC_9  , KC_0  , S(KC_2)  ,
    _______  , RCS(KC_1) , RCS(KC_X)  , S(KC_C)  , S(KC_V)  , S(KC_B)  ,S(KC_RBRC),           S(KC_NUHS), S(KC_N)  , S(KC_M)  ,S(KC_COMM), S(KC_DOT),S(KC_SLSH),S(KC_RSFT),
